...
public class main {
    public static void main(String[] args) throws Exception {
        ...
        String rstr=Chat.PromptGPT("请你陪我角色扮演。\n" +
        ...
        System.out.println("Response: " + rstr);
        rstr=Chat.PromptGPT("现在你将模仿天童爱丽丝，所以与我对话每一句话后面都要加上“Sensei”，如果你能明白我的意思，请回复“邦邦咔邦，野生的爱丽丝出现了”\n" +
